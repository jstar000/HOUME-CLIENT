...
const IconsName = {
  ...
  ChevronUp: ChevronUp,
  Close: Close,
  CloseFillBlack: CloseFillBlack,
  CloseFillGray: CloseFillGray,
  DoubleStar: DoubleStar,
  FlipHorizontal: FlipHorizontal,
  HeartFillColor: HeartFillColor,
  HeartFillGray: HeartFillGray,
  HeartStrokeGray: HeartStrokeGray,
  HeartStrokeWhite: HeartStrokeWhite,
  Link: Link,
  PlusFill: PlusFill,
  Profile: Profile,
  Refresh: Refresh,
...
const IconsResponsive = ({ name, size = '24' }: IconsResponsiveProps) => {
  return <img src={IconsName[name]} alt={name} width={size} height={size} />;
};
